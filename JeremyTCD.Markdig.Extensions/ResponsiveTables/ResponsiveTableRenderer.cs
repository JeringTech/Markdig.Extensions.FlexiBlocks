...
namespace JeremyTCD.Markdig.Extensions.ResponsiveTables
{
    ...
    /// </summary>
    public class ResponsiveTableRenderer : HtmlObjectRenderer<Table>
    {
        private readonly HtmlRenderer _stripRenderer;
        private readonly ResponsiveTableOptions _options;
        private readonly StringWriter _stringWriter;
        private readonly bool _renderWrapper;
        private readonly bool _renderLabelAttribute;

        public ResponsiveTableRenderer(ResponsiveTableOptions options)
        {
            _options = options;

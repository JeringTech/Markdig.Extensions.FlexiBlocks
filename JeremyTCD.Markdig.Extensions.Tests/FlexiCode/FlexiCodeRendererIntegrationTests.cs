...
{
    public class FlexiCodeRendererIntegrationTests : IDisposable
    {
            ...
            string expectedDivStartTag)
        {
            ...
            var dummyFlexiCodeOptions = new FlexiCodeOptions()
            {
                Attributes = dummyAttributesWrapper.Value,
                CopyIconMarkup = null,
            };
            dummyCodeBlock.SetData(FlexiCodeExtension.FLEXI_CODE_OPTIONS_KEY, dummyFlexiCodeOptions);
            FlexiCodeRenderer dummyFlexiCodeRenderer = CreateFlexiCodeRenderer();
...
<span class=""dummyPrefix-line""><span class=""dummyPrefix-line-number"">5</span><span class=""dummyPrefix-line-text"">}</span></span>"
        ...
        public FlexiCodeRenderer CreateFlexiCodeRenderer()
        {
            ...
            return new FlexiCodeRenderer(prismService, highlightJSService);
        }

...
namespace FlexiBlocks.ResponsiveTables
{
    ...
    /// </summary>
    public class FlexiTableRenderer : HtmlObjectRenderer<Table>
    {
        private readonly HtmlRenderer _stripRenderer;
        private readonly FlexiTableOptions _options;
        private readonly StringWriter _stringWriter;
        private readonly bool _renderWrapper;
        private readonly bool _renderLabelAttribute;

        public FlexiTableRenderer(FlexiTableOptions options)
        {
            _options = options;

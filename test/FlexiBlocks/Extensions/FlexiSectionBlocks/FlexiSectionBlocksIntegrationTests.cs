...
```";
            const string expectedHtml = @"<section class=""flexi-section flexi-section_level_1 flexi-section_has_link-icon"" id=""foo"">
...
# This heading is preceded by a list";
            const string expectedHtml = @"<section class=""flexi-section flexi-section_level_1 flexi-section_has_link-icon"" id=""this-heading-is-followed-by-a-list"">
<header class=""flexi-section__header"">
...
<section class=""flexi-section flexi-section_level_1 flexi-section_has_link-icon"" id=""this-heading-is-preceded-by-a-list"">
<header class=""flexi-section__header"">

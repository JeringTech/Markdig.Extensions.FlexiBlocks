...
namespace Jering.Markdig.Extensions.FlexiBlocks.FlexiCodeBlocks
{
    ...
    public interface ILineEmbellisherService
    {
        ...
        string EmbellishLines(string text, IEnumerable<NumberedLineRange> lineNumberLineRanges, IEnumerable<LineRange> highlightLineRanges, string prefixForClasses = null, string hiddenLinesIconMarkup = null);
    }
}

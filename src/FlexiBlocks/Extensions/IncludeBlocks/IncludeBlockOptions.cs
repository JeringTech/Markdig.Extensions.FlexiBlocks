...
{
    /// <summary>
    /// <para>The default implementation of <see cref="IIncludeBlockOptions"/></para>
    /// 
    ...
    /// </summary>
    public class IncludeBlockOptions : BlockOptions<IIncludeBlockOptions>, IIncludeBlockOptions
    {
        /// <summary>
        /// Creates an <see cref="IncludeBlockOptions"/>. 
        /// </summary>
        /// <param name="source">
        /// <para>The <see cref="IncludeBlock"/>'s source.</para>
        /// <para>This value must either be a relative URI or an absolute URI with scheme file, http or https.</para>
        /// <para>If this value is a relative URI and the <see cref="IncludeBlock"/> is in root content, <see cref="IIncludeBlocksExtensionOptions.BaseUri"/>
        /// is used as the base URI.</para>
        /// <para>If this value is a relative URI and the <see cref="IncludeBlock"/> is in non-root content, the absolute URI of its containing source is used as the base URI.</para>
        ...
        /// To work around this limitation, if the root content contains an <see cref="IncludeBlock"/> with a relative URI source like "../my/path/file1.md", <see cref="IncludeBlocksExtension"/> 
        /// uses <see cref="IIncludeBlocksExtensionOptions.BaseUri"/> to resolve the absolute URI of "file1.md".</para>
        /// <para>As such, <see cref="IIncludeBlocksExtensionOptions.BaseUri"/> is typically configured as the absolute URI of the root source.</para>
        /// <para>If "file1.md" contains an IncludeBlock with source "../my/path/file2.md", we use the previously resolved absolute URI of "file1.md" as the base URI to
        ...
        /// </param>
        /// <param name="type">
        /// <para>The <see cref="IncludeBlock"/>'s type.</para>
        /// <para>If this value is <see cref="IncludeType.Code"/>, the included content is rendered in a code block. 
        /// If this value is <see cref="IncludeType.Markdown"/>, the included content is processed as markdown.</para>
        ...
        /// <para>The directory to cache the <see cref="IncludeBlock"/>'s content in.</para>
        ...
        /// <para>Defaults to <c>null</c>.</para>
        /// </param>
        public IncludeBlockOptions(string source = "",

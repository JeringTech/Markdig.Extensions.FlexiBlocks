...
namespace Jering.Markdig.Extensions.FlexiBlocks.FlexiCodeBlocks
{
    ...
    public class PhraseGroup
    {
        ...
        public PhraseGroup(string regex, int[] included)
        {
        ...
        /// <exception cref="OptionsException">Thrown if <see cref="Included"/> contains an index that is out of range.</exception>
        public void GetPhrases(string text, List<Phrase> result)
        {
            ...
            else
            {
                ...
                foreach (int includedMatchIndex in Included)
                {
                    ...
                    {
                        throw new OptionsException(nameof(Included),
                            string.Format(
        ...
        {
            return $"{nameof(Regex)}: {Regex}, {nameof(Included)}: {(Included == null ? "null" : $"[{string.Join(",", Included)}]")}";
        }
        ...
        public override bool Equals(object obj)
        {
            return obj is PhraseGroup group &&
                   Regex == group.Regex &&
                   StructuralComparisons.StructuralEqualityComparer.Equals(Included, group.Included);
        }
        ...
        public override int GetHashCode()
        {
            ...
            return hashCode * -1521134295 + StructuralComparisons.StructuralEqualityComparer.GetHashCode(Included);
        }

namespace Jering.Markdig.Extensions.FlexiBlocks.FlexiSectionBlocks
{
    ...
    {
        /// <summary>
        /// Gets or sets the value used as the markup for the <see cref="FlexiSectionBlock"/> header's icon. 
        ...
        /// <summary>
        /// Gets or sets the value used as the format for <see cref="FlexiSectionBlock"/> header's class. The inserted string is the <see cref="FlexiSectionBlock"/>'s level.
        /// If the value is null, whitespace or an empty string, no class is assigned to the <see cref="FlexiSectionBlock"/> header.
        /// </summary>
        ...
        /// <summary>
        /// Sectioning content element used to wrap the section.
        /// </summary>
        public SectioningContentElement WrapperElement { get; set; }

        /// <summary>
        /// HTML attributes for the outermost element of the <see cref="FlexiSectionBlock"/>.
        /// </summary>
